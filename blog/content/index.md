...
Writing about distributed systems, developer tooling, AI workflows, and the lessons that stick after building and shipping software.

The blog index is the canonical `/blog/` landing page. If you're new here, start with a few favorites and then browse the latest posts below.
